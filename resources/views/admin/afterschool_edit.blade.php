...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Update Afterschool Information</li>
        </ol>
    </nav>
                            ...
                            @else
                                @if (!empty(old('name')))
                                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="name" name="name" value="{{ $afterschool->name }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('name')
                            ...
                            @else
                                @if (!empty(old('address')))
                                    <input type="text" id="address" name="address" value="{{ old('address') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="address" name="address" value="{{ $afterschool->address }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('address')
                            ...
                            @else
                                @if (!empty(old('city')))
                                    <input type="text" id="city" name="city" value="{{ old('city') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="city" name="city" value="{{ $afterschool->city }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('city')
                            ...
                            @else
                                @if (!empty(old('zip')))
                                    <input type="text" id="zip" name="zip" value="{{ old('zip') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="zip" name="zip" value="{{ $afterschool->zip }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('zip')
                            ...
                            @else
                                ...
                                @else
                                    <input type="text" id="phone" name="phone"
                                        value="{{ $afterschool->phone }}" class="form-textbox">
                                @endif
                            @endif
                            @error('phone')
                                <ul>
                            ...
                            @else
                                ...
                                @else
                                    <input type="email" id="email" name="email"
                                        value="{{ $afterschool->email }}" class="form-textbox">
                                @endif
                            @endif
                            @error('email')
                                <ul>
                            ...
                            @else
                                ...
                                @else
                                    <input type="text" id="location" name="location"
                                        value="{{ $afterschool->location }}" class="form-textbox">
                                @endif
                            @endif
                            @error('location')
                                <ul>
                            ...
                            @else
                                ...
                                @else
                                    <input type="text" id="capacity" name="capacity"
                                        value="{{ $afterschool->capacity }}" class="form-textbox">
                                @endif
                            @endif
                            @error('capacity')
                                <ul>
                            ...
                            @else
                                @if (!empty(old('ageRange')))
                                    <input type="text" id="ageRange" name="ageRange" value="{{ old('ageRange') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="ageRange" name="ageRange"
                                        value="{{ $afterschool->ageRange }}" class="form-textbox">
                                @endif
                            @endif
                            @error('ageRange')
                                <ul>
                            ...
                            @else
                                ...
                                @else
                                    <input type="text" id="website" name="website"
                                        value="{{ $afterschool->website }}" class="form-textbox">
                                @endif
                            @endif
                            @error('website')
                                <ul>
