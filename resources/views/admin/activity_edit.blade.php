                            ...
                            @else
                                @if (!empty(old('city')))
                                    <input type="text" id="city" name="city" value="{{ old('city') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="city" name="city" value="{{ $activity->city }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('city')
                                ...
                                @foreach ($states as $state)
                                    @if (isset($request->state))
                                        @if ($state->state_code == $request->state)
                                            <option value='{{ $state->state_code }}' selected>{{ $state->state_name }}
                                            </option>
                                        @else
                            ...
                            @else
                                @if (!empty(old('zip')))
                                    <input type="text" id="zip" name="zip" value="{{ old('zip') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="zip" name="zip" value="{{ $activity->zip }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('zip')
                            ...
                            @else
                                @if (!empty(old('phone')))
                                    <input type="text" id="phone" name="phone" value="{{ old('phone') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="phone" name="phone" value="{{ $activity->phone }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('phone')
                            ...
                            @else
                                @if (!empty(old('email')))
                                    <input type="email" id="email" name="email" value="{{ old('email') }}"
                                        class="form-textbox">
                                @else
                                    <input type="email" id="email" name="email" value="{{ $activity->email }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('email')
                            ...
                            @else
                                @if (!empty(old('url')))
                                    <input type="text" id="url" name="url" value="{{ old('url') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="url" name="url" value="{{ $activity->url }}"
                                        class="form-textbox">
                                @endif
                            @endif
                            @error('url')
                    ...
                    <tr>
                        ...
                        <td>
                            @if (isset($request->kidsProgramUrl))
                                <input type="text" id="kidsProgramUrl" name="kidsProgramUrl"
                                    value="{{ $request->kidsProgramUrl }}" class="form-textbox">
                            @else
                                @if (!empty(old('kidsProgramUrl')))
                                    <input type="text" id="kidsProgramUrl" name="kidsProgramUrl"
                                        value="{{ old('kidsProgramUrl') }}" class="form-textbox">
                                @else
                                    <input type="text" id="kidsProgramUrl" name="kidsProgramUrl"
                                        value="{{ $activity->kidsProgramUrl }}" class="form-textbox">
                                @endif
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if (isset($request->summerProgramUrl))
                                <input type="text" id="summerProgramUrl" name="summerProgramUrl"
                                    value="{{ $request->summerProgramUrl }}" class="form-textbox">
                            @else
                                @if (!empty(old('summerProgramUrl')))
                                    <input type="text" id="summerProgramUrl" name="summerProgramUrl"
                                        value="{{ old('summerProgramUrl') }}" class="form-textbox">
                                @else
                                    <input type="text" id="summerProgramUrl" name="summerProgramUrl"
                                        value="{{ $activity->summerProgramUrl }}" class="form-textbox">
                                @endif
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if (isset($request->videoUrl))
                                <input type="text" id="videoUrl" name="videoUrl" value="{{ $request->videoUrl }}"
                                    class="form-textbox">
                            @else
                                @if (!empty(old('videoUrl')))
                                    <input type="text" id="videoUrl" name="videoUrl" value="{{ old('videoUrl') }}"
                                        class="form-textbox">
                                @else
                                    <input type="text" id="videoUrl" name="videoUrl"
                                        value="{{ $activity->videoUrl }}" class="form-textbox">
                                @endif
                            @endif
                            @error('videoUrl')
                                <ul>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (isset($request->claim))
                                @if ($request->claim == 1)
                                    <label class="required"><input type="radio" name="claim" value="1"
                                            checked="checked">Yes</label>
                                    <label class="required"><input type="radio" name="claim"
                                            value="0">No</label>
                                @else
                                    <label class="required"><input type="radio" name="claim"
                                            value="1">Yes</label>
                                    <label class="required"><input type="radio" name="claim" value="0"
