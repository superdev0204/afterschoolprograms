@push('title')
    <title>{{ $state->state_name }} After School Martial Arts | {{ $state->state_name }} Taekwondo, Karake, Self Defense for
        Kids</title>
@endpush
...
@section('content')
    <div id="left-col">
        ...
        <?php echo $state->state_name; ?> Martial Art Schools <br />
        <h2><?php echo $state->state_name; ?> After School Martial Arts</h2>
        <p>Click on the city below for listings of martial art school in that city.</p>
        ...
        <div class="cities">
            ...
            foreach ($cities as $city): ?>
                ...
                <li><a href="/<?php echo $state->statefile; ?>-martial-arts/<?php echo $city->filename; ?>.html"><?php echo ucwords(strtolower($city->city)); ?></a>
                    (<?php echo $city->activities_count; ?>)</li>
                <?php endif; ?>
                <?php endforeach;?>
        ...
        <h2>New addition to <?php echo $state->state_name; ?> Martial Arts database: </h2>
        <table>
            <?php
        ...
        foreach ($activities as $activity): ?>
            <tr>
                ...
                <td valign="top">
                    <?php echo substr(strip_tags($activity->details), 0, 240); ?>...<a href="/activity-<?php echo $activity->id; ?>-<?php echo $activity->filename; ?>.html">more</a>
                </td>
            </tr>
            <?php endforeach;?>
        </table>
